...
public class juegoAhorcadoContraRelojServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		PrintWriter out = response.getWriter();
			...
			out.println("<form action=juegoAhorcadoContraRelojServlet>");
			out.println("<BR>");
			...
			if(accion == null){
				...
				out.println("<H1>JUEGO CONTRA RELOJ");
				out.println("<BR>");
